                ...
                case Request.LeaveMentor:
                    {
                        ...
                        var guide = user.Guide.Guide;
                        if (guide != null)
                        {
                            await guide.SendAsync(string.Format(Language.StrGuideBetrayTutor, user.Name));
                        }
                ...
                case Request.DumpApprentice:
                    {
                        ...
                        var tutor = user.GetStudent(Identity);
                        if (tutor == null)
                            return;
